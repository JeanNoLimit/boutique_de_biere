...
-- Listage des données de la table lechoppe.product : ~12 rows (environ)
...
-- Listage des données de la table lechoppe.product_beer_type : ~16 rows (environ)
...
-- Listage des données de la table lechoppe.shop_parameters : ~0 rows (environ)
...
-- Listage des données de la table lechoppe.user : ~0 rows (environ)
